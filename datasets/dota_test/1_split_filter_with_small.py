...
print(root_path)
dataDir = '/home/bibahaduri/dota_dataset/coco/annotations'##'./annotations'
support_dict = {}
...
voc_inds = (2,4,14)##(0, 1, 2, 3, 4, 5, 6, 8, 14, 15, 16, 17, 18, 19, 39, 56, 57, 58, 60, 62)


for dataType in ['instances_test2017.json']:
