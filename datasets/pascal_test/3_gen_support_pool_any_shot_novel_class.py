...
def main(shot):
    ...
    for dataType in ['test']:##['trainval2014']:
        set_crop_base_path = join(support_path, dataType)
        set_img_base_path = join(dataDir, dataType)
        
        annFile = os.path.join(root_path, 'new_annotations/final_split_voc_{}_shot_instances_test2014.json'.format(shot))
...
if __name__ == '__main__':
    for shot in [10]:##[1, 2, 3, 5, 10, 30]:  1, 3, 5, 
        ...
        support_df.to_pickle("./{}_test_shot_support_df.pkl".format(shot))
