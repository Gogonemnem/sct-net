...
print(root_path)
dataDir = '/home/bibahaduri/pascalvoc/coco/annotations'##'./annotations'
support_dict = {}
...
voc_inds = (2,5,9,13,17)##(0, 2, 16, 17, 19)##(0, 1, 2, 3, 4, 5, 6, 8, 14, 15, 16, 17, 18, 19, 39, 56, 57, 58, 60, 62)(2,4,9,13,17)


for dataType in ['instances_test.json']:
    ...
    split2_file = os.path.join(root_path, 'new_annotations/final_split_non_voc_instances_test2014_with_small.json')

    with open(split2_file, 'w') as f:
        json.dump(dataset_split2, f) 

    print("Total number of boxes is ", len(annotations_split2))
